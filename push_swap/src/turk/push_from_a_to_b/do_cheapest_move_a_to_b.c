...
/*   Updated: 2025/04/24 18:54:29 by saalarco         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
If price_a and price_b are both positive or both negative, it means that the cheapest 
move is to rotate/reverse rotate both stacks in the same direction, and then rotate until both are
at the top. Then push a to b.
If price_a is positive and price_b is negative, it means that the cheapest move is to
rotate stack_a and reverse rotate stack_b, and then push a to b.
If price_a is negative and price_b is positive, it means that the cheapest move is to
